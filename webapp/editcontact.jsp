			...
			<div class="col-md-4 offset-md-4">
				<div class="card">
					<div class="card-body">
						...
						if (sucssMsg != null) {
						%>
						<p class="text-success text-center"><%=sucssMsg%>
						</p>
						<%
						...
						<form action="update" method="post">
							...
							<div class="form-group">
								<label for="exampleInputEmail1"> Username </label> <input value="<%=c.getName() %>"
									name="name" type="text" class="form-control"
									id="exampleInputEmail1" aria-describedby="emailHelp">

							</div>
							<div class="form-group">
								<label for="exampleInputEmail1">Login Id</label> <input value="<%=c.getEmail() %>"
									name="email" type="email" class="form-control"
									id="exampleInputEmail1" aria-describedby="emailHelp">

							</div>
							<div></div>
							<label for="exampleInputEmail1">Contact number</label> <input value="<%=c.getPhno() %>"
